Biondolillo_2021=["I usually ignore others' feedback.", "I usually consider others' feedback.",
"I'm unprepared for what's happening.",
"I'm prepared for what's happening.", 'Sacrificing for tomorrow is pointless.',
'Sacrificing for tomorrow is practical.', 'I rarely consider long-term consequences.',
'I frequently consider long-term consequences.', 'My decisions are made quickly.',
...
'I can complete difficult tasks as long as they will help me get ahead.', 'I make lists of things to do.',
...
RESS=["Looking at different angles.",
...
"As I look back on my life, all I can see is a lot of failures.",
"I feel I am a complete failure as a person.",
"I don't feel like I'm any worse than anybody else.",
...
"I am worried about physical problems like aches, pains, or soreness.",
"I am very worried about physical problems and it's hard to think about much else.",
"I am so worried about physical problems that I cannot think of anything else."]
...
CESD=["During the past week I was bothered by things that usually don't bother me.",
"During the past week I did not feel like eating; my appetite was poor.",
"During the past week I felt that I could not shake off the blues even with help from family or friends.",
...
"I have to make a big effort to start or finish my usual daily activities.",
...
MADRS=["Apparent sadness. Despondency, gloom, and despair (more than just ordinary transient low spirits), reflected in speech, facial expression, and posture; rate by depth and inability to brighten up.",
"No sadness.",
"Looks dispirited but brightens up without difficulty.",
"Looks sad and unhappy most of the time.",
"Looks miserable all the time; extremely despondent.",
"Reported sadness. Reports of depressed mood, regardless of whether it is reflected in appearance or not; includes low spirits, despondency, or the feeling of being beyond help and without hope.",
...
"Inner tension. Feelings of ill-defined discomfort, edginess, inner turmoil, mental tension mounting to either panic, dread, or anguish; rate by intensity, frequency, duration, and extent of reassurance called for.",
...
"Reduced sleep. Experience of reduced duration or depth of sleep compared to the patient's own normal pattern when well.",
"Sleeps as normal.",
...
"Reduced appetite. Feeling of loss of appetite; rate by loss of desire for food or the need to force oneself to eat.",
"Normal or increased appetite.",
"Slightly reduced appetite.",
"No appetite; food is tasteless.",
"Needs persuasion to eat.",
"Concentration difficulty. Difficulties in collecting one’s thoughts mounting to incapacitating lack of concentration; rate by intensity, frequency, and degree of incapacity produced.",
...
"Lassitude. Difficulty getting started or slowness initiating and performing everyday activities.",
...
"Inability to feel. Subjective experience of reduced interest in the surroundings or activities that normally give pleasure; the ability to react with adequate emotion to circumstances or people is reduced.",
...
"Pessimistic thoughts. Thoughts of guilt, inferiority, self reproach, sinfulness, remorse, and ruin.",
...
"Suicidal thoughts. Feeling that life is not worth living, that a natural death would be welcome, suicidal thoughts, and the preparations for suicide; suicidal attempts should not in themselves influence the rating.",
"Enjoys life.",
